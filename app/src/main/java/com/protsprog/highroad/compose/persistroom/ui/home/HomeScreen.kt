...
import com.protsprog.highroad.compose.persistroom.ui.item.formatedPrice
import com.protsprog.highroad.compose.persistroom.ui.theme.InventoryTheme
import com.protsprog.highroad.nav.InventoryHomeDestination
...
fun InventoryHomeScreen(
    ...
    val stateUi = viewModel.homeUiState.collectAsStateWithLifecycle()

    Scaffold(
        modifier = modifier.nestedScroll(scrollBehavior.nestedScrollConnection),
        topBar = {
            InventoryTopAppBar(
                title = stringResource(InventoryHomeDestination.titleRes),
        ...
        HomeBody(
            itemList = stateUi.value.itemList,
