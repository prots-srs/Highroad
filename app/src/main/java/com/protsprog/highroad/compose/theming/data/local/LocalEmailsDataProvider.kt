package com.protsprog.highroad.compose.theming.data.local

import com.protsprog.highroad.R
import com.protsprog.highroad.compose.theming.data.Email
import com.protsprog.highroad.compose.theming.data.EmailAttachment
import com.protsprog.highroad.compose.theming.data.MailboxType
...
object LocalEmailsDataProvider {
    ...
    val allEmails = mutableListOf(
        ...
        Email(
            ...
            listOf(
                EmailAttachment(R.drawable.reply_paris_1, "Bridge in Paris"),
                EmailAttachment(R.drawable.reply_paris_2, "Bridge in Paris at night"),
                EmailAttachment(R.drawable.reply_paris_3, "City street in Paris"),
                EmailAttachment(R.drawable.reply_paris_4, "Street with bike in Paris")
            ),
            true,
            createAt = "1 hour ago",
            threads = threads,
