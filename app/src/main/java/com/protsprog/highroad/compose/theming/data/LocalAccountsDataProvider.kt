...
object LocalAccountsDataProvider {
   ...
   private val allUserAccounts = listOf(
        Account(
            ...
            avatar = R.drawable.theming_avatar_10,
        ...
        Account(
            ...
            avatar = R.drawable.theming_avatar_2
        ),
        Account(
            id = 3L,
            uid = 0L,
            ...
            avatar = R.drawable.theming_avatar_9
        )
    )
    ...
    private val allUserContactAccounts = listOf(
        Account(
            ...
            avatar = R.drawable.theming_avatar_1
        ),
        Account(
            id = 5L,
            uid = 2L,
            ...
            avatar = R.drawable.theming_avatar_3
        ),
        Account(
            id = 6L,
            uid = 3L,
            ...
            avatar = R.drawable.theming_avatar_5
        ),
        Account(
            id = 7L,
            uid = 4L,
            ...
            avatar = R.drawable.theming_avatar_0
        ),
        Account(
            id = 8L,
            uid = 5L,
            ...
            avatar = R.drawable.theming_avatar_7
        ),
        Account(
            id = 9L,
            uid = 6L,
            ...
            avatar = R.drawable.theming_avatar_express
        ),
        Account(
            id = 10L,
            uid = 7L,
        ...
        Account(
            ...
            avatar = R.drawable.theming_avatar_8
        ),
        Account(
            id = 12L,
            uid = 9L,
            ...
            avatar = R.drawable.theming_avatar_6
        ),
        Account(
            id = 13L,
            uid = 10L,
            ...
            avatar = R.drawable.theming_avatar_4
        )
    )
