...
import com.protsprog.highroad.compose.theming.data.Account
...
object LocalAccountsDataProvider {
    ...
    private val allUserContactAccounts = listOf(
        ...
        Account(
            ...
            "express@google.com",
            "express@gmail.com",
            R.drawable.reply_avatar_express
        ),
        Account(
            10L,
            7L,
