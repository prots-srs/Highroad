package com.protsprog.highroad.compose.navigation.ui.components
...
fun AccountRow(
    ...
    BaseRow(
        ...
        color = color,
        title = name,
        subtitle = stringResource(R.string.navigation_account_redacted) + AccountDecimalFormat.format(number),
        amount = amount,
        negative = false
    )
}
