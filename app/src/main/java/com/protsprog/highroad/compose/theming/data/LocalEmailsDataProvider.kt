...
object LocalEmailsDataProvider {
    ...
    private val threads = listOf(
        ...
        Email(
            ...
            attachments = listOf(
                EmailAttachment(R.drawable.theming_paris_1, "Bridge in Paris"),
                EmailAttachment(R.drawable.theming_paris_2, "Bridge in Paris at night"),
                EmailAttachment(R.drawable.theming_paris_3, "City street in Paris"),
                EmailAttachment(R.drawable.theming_paris_4, "Street with bike in Paris")
            ),
            isImportant = true,
            isStarred = true,
